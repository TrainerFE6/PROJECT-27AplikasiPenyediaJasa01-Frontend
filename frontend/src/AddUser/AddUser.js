...
const TambahUser = () => {
  ...
  useEffect(() => {
    axios
      .get("https://api-msib-6-penyedia-jasa-02.educalab.id/users")
      .then((response) => {
  ...
  const deleteUser = (id) => {
    axios
      .delete(`https://api-msib-6-penyedia-jasa-02.educalab.id/users/${id}`)
      .then((response) => {
              ...
              <td>
                {user.gambar ? (
                  <img
                    ...
                    src={`https://api-msib-6-penyedia-jasa-02.educalab.id/uploads/users/${user.gambar}`}
                    alt="Gambar User"
                  />
                ) : (
                  "No Image"
