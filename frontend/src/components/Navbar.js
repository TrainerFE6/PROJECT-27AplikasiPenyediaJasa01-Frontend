...
//   const [showLogout, setShowLogout] = useState(false);
  ...
  const profileImage =
    user && user.gambar
      ? `http://localhost:5000/uploads/${user.gambar}`
      : jasaku;
    ...
    <div>
      <div className={classes.navbar}>
        ...
        <div className={classes.navbarList}>
          ...
          <Link
            to="/catalog"
            className={`${classes.list} ${getNavLinkClass("/catalog")}`}
          >
            Layanan
          </Link>
          <Link
            to="/about"
            className={`${classes.list} ${getNavLinkClass("/about")}`}
          >
            About Us
          </Link>
        </div>
      ...
      >
        <div className={classes.navbarListMobile}>
          <Link
            to="/"
            className={`${classes.listMobile} ${getNavLinkClass("/")}`}
          >
            Home
          </Link>
          <Link
            to="/catalog"
            className={`${classes.listMobile} ${getNavLinkClass("/catalog")}`}
          >
            Layanan
          </Link>
          <Link
            to="/about"
            className={`${classes.listMobile} ${getNavLinkClass("/about")}`}
          >
            About Us
          </Link>
        </div>
