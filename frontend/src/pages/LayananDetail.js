...
const LayananDetail = () => {
  ...
  const { id, imageLayanan, title, location: layananLocation, price } = location.state || {};
  ...
  return (
    <div>
      ...
      <div className={classes.product}>
        ...
        <Link to={`/formpembelian/`} className='d-grid text-decoration-none' state={{ id, title, price }}>
